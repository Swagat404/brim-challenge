...
export function AnomalousMatterHero({
  ...
  return (
    <section
      role="banner"
      className="relative w-full h-[40vh] bg-transparent text-zinc-900 overflow-hidden rounded-[24px] border border-zinc-200/60 shadow-sm"
    >
      ...
      <div className="relative z-20 flex flex-col items-center justify-end h-full pb-10 text-center">
        <div className="max-w-3xl px-4 animate-fade-in-long">
          <h1 className="text-xs font-mono tracking-widest text-[#8b9286] uppercase mb-2">
            {title}
          </h1>
          <p className="text-2xl md:text-4xl font-bold leading-tight tracking-tight">
            {subtitle}
          </p>
          <p className="mt-3 max-w-xl mx-auto text-sm leading-relaxed text-zinc-500 font-medium">
            {description}
          </p>
        </div>
      </div>
