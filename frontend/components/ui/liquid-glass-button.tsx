  ...
  return (
    ...
    >
      <div className="absolute top-0 left-0 z-0 h-full w-full rounded-full 
          bg-white shadow-[0_2px_10px_rgba(0,0,0,0.05),inset_1px_1px_2px_rgba(255,255,255,1),inset_-1px_-1px_2px_rgba(0,0,0,0.05)] 
      transition-all" />
      <div
      ...
      <div className="pointer-events-none z-10 w-full flex items-center">
        {children}
      </div>
      <GlassFilter />
    </Comp>
